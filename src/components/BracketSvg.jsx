  ...
  matchups.forEach((match, i) => {
    ...
    lines.push(
      <path key={`hl-${i}`} opacity={mOp}
        ...
        fill="none" stroke={homePathCol} strokeWidth="4.2" strokeOpacity="0.85" strokeLinejoin="round" />,
      <path key={`al-${i}`} opacity={mOp}
        className={liveClass}
        d={arcElbow(posAway, faTeam(i * 2 + 1), R_R32, posR32, 0)}
        fill="none" stroke={awayPathCol} strokeWidth="4.2" strokeOpacity="0.85" strokeLinejoin="round" />,
    );
