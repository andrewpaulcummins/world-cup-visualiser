...
const TEAM_LOOKUP = {
  ...
  TRI:'TTO', DOM:'DOM',
  SUI:'CHE', ALG:'DZA', CGO:'COD', BOS:'BIH', CVE:'CPV', SAF:'RSA', CVI:'CPV', CAP:'CPV',
  'Cabo Verde':'CPV', 'Democratic Republic of the Congo':'COD', 'Congo, DR':'COD',
  'Bosnia & Herzegovina':'BIH', 'Cote d\'Ivoire':'CIV', 'Ivory Coast':'CIV',
